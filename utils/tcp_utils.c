...
=======
>>>>>>> parent of 1b2a97e... Holy Mack. I think it's all working, with a current packet loss rate of 3 out of every 85. I just need to sift and see what's happening.
  printf("\n*************\n");
